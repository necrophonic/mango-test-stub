...
plan tests => 15;
    ...
    lives_ok {$mango->inactivity_timeout}   q|attribute 'inactivity_timeout' ok|;
    lives_ok {$mango->ioloop}               q|attribute 'credentials' ok|;
    lives_ok {$mango->j}                    q|attribute 'j' ok|;
    lives_ok {$mango->max_bson_size}        q|attribute 'max_bson_size' ok|;
    lives_ok {$mango->max_connections} 	    q|attribute 'max_connections' ok|;
    lives_ok {$mango->max_write_batch_size} q|attribute 'max_write_batch_size' ok|;
    ...
    can_ok 'Mango', qw|default_db hosts inactivity_timeout ioloop j
                       max_bson_size max_connections max_write_batch_size
                       protocol w wtimeout
                       backlog db from_string get_more
